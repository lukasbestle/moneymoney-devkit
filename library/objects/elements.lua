...
function elements:each(func) end

---**Reverses the order of the HTML elements**
---
---@return Elements elements
function elements:reverse() end

---**Returns the direct children elements**
---
---@return Elements elements
function elements:children() end
...
---@return Elements elements
function elements:xpath(query) end
...
function elements:attr(attribute) end
...
---@diagnostic disable-next-line:duplicate-set-field
function elements:attr(attribute, value) end
...
---
---@param value string
function elements:select(value) end
